...
class AuthorProfileController extends Controller
{
    ...
    {
        $authUser = auth()->user();
        return view('author.profile.index', compact('authUser'));
    }
    ...
    {
        $authUser = auth()->user();
        return view('author.profile.profile-edit', compact('authUser'));
    }
    ...
    public function submitEditProfilePage(Request $request)
    {
        ...
        return redirect()->route('author.profile')->with('success', 'Your Profile Updated Successfully');
    }


    public function showEditPasswordPage()
    {
        return view('author.profile.password-edit');
    }
