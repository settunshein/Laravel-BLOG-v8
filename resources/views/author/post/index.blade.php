...
<div class="row">
    <div class="col-md-12 mb-3 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('author.post.create') }}" class="btn btn-outline-dark rounded-0 btn-sm">
    ...
    <div class="col-md-6">
        <div class="card custom-mb-30 shadow-sm rounded-0">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <span>
                    <a href="{{ route('author.post.show', $post->id) }}" class="btn btn-sm btn-outline-dark rounded-0">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{ route('author.post.edit', $post->id) }}" class="btn btn-sm btn-outline-dark rounded-0">
                ...
                <span class="badge badge-{{$post->status==1 ? 'success' : 'danger'}} rounded-0 px-3 py-2 custom-fs-11">
